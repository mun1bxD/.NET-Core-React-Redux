# Here is the javascript files for handling redux
...
const WISH_ADD_ITEM = "wish/addItem";
const WISH_REMOVE_ITEM = "wish/removeItem";
...
const reducers = (state = initialState, action) => {
  switch (action.type) {
    ...
    case CART_INCREASE_ITEM:
      return {
        ...state,
        cardItem: state.cardItem.map((cardItem) => {
